...
histnew <- ggplot(paired, aes(x=transect, y=newgrowth)) +
  geom_bar(stat="identity") + theme_classic() + theme(text = element_text(size=12))

histvol <- ggplot(paired, aes(x=transect, y=volume)) +
  geom_bar(stat="identity") + theme_classic() + theme(text = element_text(size=12))

histbra <- ggplot(paired, aes(x=transect, y=branches)) +
  geom_bar(stat="identity") + theme_classic() + theme(text = element_text(size=12))

histbud <- ggplot(paired, aes(x=transect, y=buds)) +
  geom_bar(stat="identity") + theme_classic() + theme(text = element_text(size=12))

histfru <- ggplot(paired, aes(x=transect, y=fruits)) +
  geom_bar(stat='identity') + theme_classic() + theme(text = element_text(size=12))

histfruw <- ggplot(master, aes(x=tag, y=fruit.weight)) +
  geom_bar(stat='identity') + theme_classic() + theme(text = element_text(size=12))

histfruv <- ggplot(master, aes(x=tag, y=fruit.volume)) +
  geom_bar(stat='identity') + theme_classic() + theme(text = element_text(size=12))
...
#buds and fruit weight
bfw <- cor.test(master$buds, master$fruit.weight, method="pearson")
bfw #not correlated
#buds and fruit volume
bfv <- cor.test(master$buds, master$fruit.volume, method="pearson")
bfv #not correlated
#fruit number and fruit weight
ffw <- cor.test(master$fruits, master$fruit.weight, method="pearson")
ffw #not correlated
#fruit number and fruit volume
ffv <- cor.test(master$fruits, master$fruit.volume, method="pearson")
ffv #not correlated
#fruit weight and fruit volume
fwfv <- cor.test(master$fruit.weight, master$fruit.volume, method="pearson")
fwfv #positively correlated
